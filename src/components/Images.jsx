export const Images = () => {
  return (
    <div className="flex justify-between items-center w-full md:w-[1728px] h-[200px] mx-auto relative">
      ...
      <div className="hidden md:block w-[315px] h-[296px] overflow-hidden absolute top-[75%] left-[15%] rounded-[45px]">
        <img
      ...
      <div className="hidden md:block w-[438px] h-[412px] overflow-hidden absolute top-[100%] left-[50%] rounded-[45px]">
        <img
      ...
      <div className="h-[100px] w-[166px] md:h-[227px] overflow-hidden absolute top-[100px] md:top-[25%] right-0 rounded-l-[45px]">
        <img
