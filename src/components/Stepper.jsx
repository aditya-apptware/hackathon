...
const Stepper = () => {
  ...
  return (
    <div
      className={`overflow-y-auto overflow-x-hidden w-full h-full z-10 py-16 relative flex flex-col justify-center ${
    ...
    >
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="h-fit overflow-y-scroll overflow-x-hidden flex flex-col justify-start"
        >
